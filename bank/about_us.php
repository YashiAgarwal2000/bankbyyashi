...
<head>
    ...
    <title>About us - Agarwal's Bank</title>
...
<body style="background-color:#7FB3D5;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:#EDBB99; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:black;">About Us</h1>
            </div>
            <br><br>
            <img src="statics/yashipic.png" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <h6><p style="color:black;">This website is created by</p></h6>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Yashi Agarwal</h1>
