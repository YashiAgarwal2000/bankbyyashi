...
<head>
    ...
    <title>All customers - Agarwal's Bank</title>
...
<body style="background-color:#CCD1D1;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:#7FB3D5; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
