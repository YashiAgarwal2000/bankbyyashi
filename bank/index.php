...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="statics/32-logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/16-logo.png">
    ...
    <title>Welcome to Agarwal's Bank</title>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:candara; font-size:20px; box-shadow: 0px 0px 10px 0px white;">
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logoo.png" alt=""
                    style="height: 110px; margin-left:25px; margin-top:10px;"></a>
    ...
    <div class="container-large"
        style="color:white; height:450px; width: 100%; padding:8% 2% 2% 2%; background-color:#212529;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:60px; text-shadow:2px 3px 3px grey; text-align:center;"><b>Welcome to <br> Agarwal's
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/finance-removebg-preview.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#7FB3D5; color:black; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                    ...
                    <div class="col-lg">
                        <div
                            style="background-color:#D7BDE2; color:black; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                    ...
                    <div class="col-lg">
                        <div
                            style="background-color:#CACFD2; color:black; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
