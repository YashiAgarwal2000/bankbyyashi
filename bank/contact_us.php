...
<head>
    ...
    <title>Contact us - Agarwal's Bank</title>
</head>

<body style="background-image:url('statics/bg.jpg'); padding-top:10%;">
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:80%; background-color:#7FB3D5; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px black;">
                <h1 style=" color:black;">Contact Us</h1>
            </div>

            <div class="container"
                style=" backdrop-filter: blur(2px);  border-radius:5px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%;">
